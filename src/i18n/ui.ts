...
export const ui = {
  en: {
    ...
    "features.desc.explore": "Explore our continuously growing collection of program ideas contributed by our community members. There are ideas for everyone!",
    ...
    "features.desc.connect":
      "Make deciding where to go quicker by saving the ideas you like to your favourites — you'll always have one on hand!",
 ...
 //     "Tedd könnyebbé a szervezést csoportok létrehozásával. Hozzatok létre egy közös listát azokkal a program ötletekkel, amelyeken szívesen részt vennétek közösen!",
    "features.desc.connect":
      "Tedd gyorsabbá az ötletkeresést azzal, hogy elmented a kedvenceid közé, ami tetszik – így mindig kéznél lesz egy!",
    "features.desc.memories":
      "Készíts polariodokat emlékeidről és akaszd ki a galériádba, hogy bármikor visszanézhesd kedvenceid!",
    "features.desc.shareidea":
