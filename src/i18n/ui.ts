...
export const ui = {
  en: {
    ...
    "features.desc.memories":
      "Have a beautiful list of all the activities you’ve been to with your loved one. Create albums and remember your best times together!",
  ...
  hu: {
    ...
    "hero.title": "Fedezd fel a körülötted rejlő programokat!",
